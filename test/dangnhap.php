...
if (isset($_POST['dangnhap'])) {
    ...
    if (mysqli_num_rows($query) == 0) {
        ...
        echo "Xin chào " . $username . ". Bạn đã đăng nhập thành công. <a href='./admincode/accounts.php'>Về trang admin</a>";
        die();
    } // Kiểm tra nếu phân quyền sai thì đưa đến trang người dùng
    else if (mysqli_num_rows($queryCheck) == false) {
        $_SESSION['username'] = $username;
        echo "Xin chào " . $username . ". Bạn đã đăng nhập thành công. <a href='cart.php'>Về trang chủ</a>";
        die();
    }
    ...
    // //Lưu tên đăng nhập
    // $_SESSION['username'] = $username;
    // echo "Xin chào " . $username . ". Bạn đã đăng nhập thành công. <a href='./accounts.php'>Về trang chủ</a>";
    // die();
}
